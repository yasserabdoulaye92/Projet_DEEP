 ...
 * @brief Configuration des modules HAL utilisés par le projet.
 *
 * Ce fichier permet d'activer ou désactiver les périphériques
 * de la bibliothèque HAL STM32 ainsi que certains paramètres
 * généraux du microcontrôleur.
 */
